...
REGISTER_CLASS_WITH_NAMESPACE(ArchiveDataNode, DAVA::);
...
REGISTER_CLASS_WITH_NAMESPACE(SceneRenderConfig, DAVA::);
...
REGISTER_CLASS_WITH_NAMESPACE(MapBorderRenderObject, DAVA::);
...
REGISTER_CLASS_WITH_NAMESPACE(ParticleMeshesComponent, DAVA::);
