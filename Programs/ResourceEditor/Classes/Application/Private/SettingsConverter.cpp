...
#define LOAD_SETTING(settingsVar, field, key, convertFn) \
    settingsVar->field = GetValue(key, settingsVar->field).convertFn()
        ...
        LOAD_SETTING(generalSettings, enableMaterialsMigration, Enable_Materials_Migration, AsBool);
...
private:
    ...
    const DAVA::String Enable_Materials_Migration = "EnableMaterialsMigration/EnableMaterialsMigration";
